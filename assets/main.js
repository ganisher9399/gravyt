    ...
    t.prototype = {
        _init: function() {
            var t, s, i, e, n = "BODY" === this.elmt.tagName,
                ...
                r = this;
            this._preload(), n || (s = b('<div class="vegas-content-scrollable">'), t = b('<div class="vegas-content">').css("overflow", this.$elmt.css("overflow")).css("padding", this.$elmt.css("padding")), this.$elmt.css("padding", 0), this.$elmt.css("padding") || t.css("padding-top", this.$elmt.css("padding-top")).css("padding-bottom", this.$elmt.css("padding-bottom")).css("padding-left", this.$elmt.css("padding-left")).css("padding-right", this.$elmt.css("padding-right")), this.$elmt.clone(!0).children().appendTo(t), this.elmt.innerHTML = ""), o && this.support.transition && (e = b('<div class="vegas-timer"><div class="vegas-timer-progress">'), this.$timer = e, this.$elmt.prepend(e)), a && (i = b('<div class="vegas-overlay">'), "string" == typeof a && i.css("background-image", "url(" + a + ")"), this.$overlay = i, this.$elmt.prepend(i)), this.$elmt.addClass("vegas-container"), n || (this.$elmt.append(s), s.append(t)), setTimeout(function() { r.trigger("init"), r._goto(r.slide), r.settings.autoplay && r.trigger("play") }, 1)
        },
        _preload: function() { var t; for (t = 0; t < this.settings.slides.length; t++)(this.settings.preload || this.settings.preloadImages) && this.settings.slides[t].src && ((new Image).src = this.settings.slides[t].src), (this.settings.preload || this.settings.preloadVideos) && this.support.video && this.settings.slides[t].video && (this.settings.slides[t].video instanceof Array ? this._video(this.settings.slides[t].video) : this._video(this.settings.slides[t].video.src)) },
        _random: function(t) { return t[Math.floor(Math.random() * t.length)] },
        _slideShow: function() {
            var t = this;
            1 < this.total && !this.ended && !this.paused && !this.noshow && (this.timeout = setTimeout(function() { t.next() }, this._options("delay")))
        },
        _timer: function(t) {
            var s = this;
        ...
        _fadeOutSound: function(t, s) {
            var i = this,
                e = s / 10,
                n = t.volume - .09;
            0 < n ? (t.volume = n, setTimeout(function() { i._fadeOutSound(t, s) }, e)) : t.pause()
        },
        ...
        _goto: function(t) {
            ...
            this.settings.firstTransition && this.first && (f = this.settings.firstTransition || f), this.settings.firstTransitionDuration && this.first && (v = this.settings.firstTransitionDuration || v), this.first && (this.first = !1), "repeat" !== u && (!0 === u ? u = "cover" : !1 === u && (u = "contain")), ("random" === f || f instanceof Array) && (f = f instanceof Array ? this._random(f) : this._random(this.transitions)), ("random" === y || y instanceof Array) && (y = y instanceof Array ? this._random(y) : this._random(this.animations)), ("auto" === v || d < v) && (v = d), "auto" === _ && (_ = d), s = b('<div class="vegas-slide"></div>'), this.support.transition && f && s.addClass("vegas-transition-" + f), this.support.video && h ? ((n = h instanceof Array ? this._video(h) : this._video(h.src)).loop = void 0 === h.loop || h.loop, n.muted = void 0 === h.mute || h.mute, !1 === n.muted ? (n.volume = 0, this._fadeInSound(n, v)) : n.pause(), e = b(n).addClass("vegas-video").css("background-color", c), this.support.objectFit ? e.css("object-position", l + " " + g).css("object-fit", u).css("width", "100%").css("height", "100%") : "contain" === u && e.css("width", "100%").css("height", "100%"), s.append(e)) : (o = new Image, i = b('<div class="vegas-slide-inner"></div>').css("background-image", 'url("' + r + '")').css("background-color", c).css("background-position", l + " " + g), "repeat" === u ? i.css("background-repeat", "repeat") : i.css("background-size", u), this.support.transition && y && i.addClass("vegas-animation-" + y).css("animation-duration", _ + "ms"), s.append(i)), this.support.transition || s.css("display", "none"), m ? a.eq(m - 1).after(s) : this.$elmt.prepend(s), a.css("transition", "all 0ms").each(function() { this.className = "vegas-slide", "VIDEO" === this.tagName && (this.className += " vegas-video"), f && (this.className += " vegas-transition-" + f, this.className += " vegas-transition-" + f + "-in") }), p._timer(!1), n ? (4 === n.readyState && (n.currentTime = 0), n.play(), w()) : (o.src = r, o.complete ? w() : o.onload = w)
        },
        _end: function() { this.ended = !this.settings.autoplay, this._timer(!1), this.trigger("end") },
        shuffle: function() { for (var t, s, i = this.total - 1; 0 < i; i--) s = Math.floor(Math.random() * (i + 1)), t = this.settings.slides[i], this.settings.slides[i] = this.settings.slides[s], this.settings.slides[s] = t },
        ...
        var i, e = arguments,
            n = !1;
        if (void 0 === s || "object" == typeof s) return this.each(function() { this._vegas || (this._vegas = new t(this, s)) });
        if ("string" == typeof s) { if (this.each(function() { var t = this._vegas; if (!t) throw new Error("No Vegas applied to this element."); "function" == typeof t[s] && "_" !== s[0] ? i = t[s].apply(t, [].slice.call(e, 1)) : n = !0 }), n) throw new Error('No method "' + s + '" in Vegas.'); return void 0 !== i ? i : this }
    }, b.vegas = {}, b.vegas.defaults = e, b.vegas.isVideoCompatible = function() { return !/(Android|webOS|Phone|iPad|iPod|BlackBerry|Windows Phone)/i.test(navigator.userAgent) }
...
function() {
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function(i, e) {
        var s = (new Date).getTime(),
            o = Math.max(0, 16 - (s - t)),
            n = window.setTimeout(function() { i(s + o) }, o);
        return t = s + o, n
...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            function isIframe() { var a = !1; try { self.location.href != top.location.href && (a = !0) } catch (b) { a = !0 } return a }
            if (ytp.YTAPIReady || "undefined" != typeof window.YT) setTimeout(function() { jQuery(document).trigger("YTAPIReady"), ytp.YTAPIReady = !0 }, 100);
            else {
                jQuery("#YTAPI").remove();
            ...
            return this.each(function() {
                ...
                if (jQuery.mbCookie.get("YTPlayer_start_from" + YTPlayer.videoID) && (start_from_last = parseFloat(jQuery.mbCookie.get("YTPlayer_start_from" + YTPlayer.videoID))), YTPlayer.opt.remember_last_time && start_from_last && (YTPlayer.start_from_last = start_from_last, jQuery.mbCookie.remove("YTPlayer_start_from" + YTPlayer.videoID)), YTPlayer.isPlayer = $YTPlayer.is(YTPlayer.opt.containment), YTPlayer.isBackground = YTPlayer.opt.containment.is("body"), !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    YTPlayer.isPlayer && $YTPlayer.show(), YTPlayer.overlay = jQuery("<div/>").css({ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }).addClass("YTPOverlay"), YTPlayer.isPlayer && YTPlayer.overlay.on("click", function() { $YTPlayer.YTPTogglePlay() }), YTPlayer.wrapper = jQuery("<div/>").addClass("mbYTP_wrapper").attr("id", "wrapper_" + YTPlayer.id), YTPlayer.wrapper.css({ position: "absolute", zIndex: 0, minWidth: "100%", minHeight: "100%", left: 0, top: 0, overflow: "hidden", opacity: 0 });
                    ...
                    jQuery.mbBrowser.mobile && YTPlayer.opt.autoPlay && YTPlayer.opt.useOnMobile && jQuery("body").one("touchstart", function() { YTPlayer.player.playVideo() }), jQuery(document).one("YTAPIReady", function() { $YTPlayer.trigger("YTAPIReady_" + YTPlayer.id), ytp.YTAPIReady = !0 }), YTPlayer.isOnScreen = jQuery.mbYTPlayer.isOnScreen(YTPlayer), $YTPlayer.one("YTAPIReady_" + YTPlayer.id, function() {
                        var a = this,
                            b = jQuery(a);
                        a.isBackground && ytp.backgroundIsInited || a.isInit || (a.isBackground && (ytp.backgroundIsInited = !0), a.opt.autoPlay = "undefined" == typeof a.opt.autoPlay ? a.isBackground ? !0 : !1 : a.opt.autoPlay, a.opt.vol = a.opt.vol ? a.opt.vol : 100, jQuery.mbYTPlayer.getDataFromAPI(a), jQuery(a).on("YTPChanged", function(c) {
                            if (!a.isInit) {
                                a.isInit = !0;
                                var d = { modestbranding: 1, autoplay: 0, controls: 0, showinfo: 0, rel: 0, enablejsapi: 1, version: 3, playerapiid: a.playerID, origin: "*", allowfullscreen: !0, wmode: "transparent", iv_load_policy: a.opt.showAnnotations, cc_load_policy: a.opt.cc_load_policy, playsinline: jQuery.browser.mobile ? 1 : 0, html5: document.createElement("video").canPlayType ? 1 : 0 };
                                new YT.Player(a.playerID, {
                                    playerVars: d,
                                    events: {
                                        onReady: function(c) { a.player = c.target, a.player.loadVideoById({ videoId: a.videoID.toString(), suggestedQuality: a.opt.quality }), b.trigger("YTPlayerIsReady_" + a.id) },
                                    ...
                                    return a.isReady ? this : (a.playerEl = a.player.getIframe(), jQuery(a.playerEl).unselectable(), b.optimizeDisplay(), jQuery(window).off("resize.YTP_" + a.id).on("resize.YTP_" + a.id, function() { b.optimizeDisplay() }), a.opt.remember_last_time && jQuery(window).on("unload.YTP_" + a.id, function() {
        ...
        playlist: function(a, b, c) {
            function d(h, i) {
                ...
                jQuery.getJSON(j, { part: "snippet,contentDetails", playlistId: h, maxResults: 50, pageToken: i, key: jQuery.mbYTPlayer.apiKey }).done(function(h) { e(h), h.nextPageToken ? (i = h.nextPageToken, d(plID, i, a)) : f.YTPlaylist(g.videos, b, c) })
            }

            function e(a) { for (var b = a.items.length, c = 0; b > c; c++) g.videos.push({ videoURL: a.items[c].contentDetails.videoId }) }
            var f = this,
                g = f.get(0);
            return "String" == typeof a && "" != jQuery.mbYTPlayer.apiKey ? (d(a), this) : (g.isList = !0, b && (a = jQuery.shuffle(a)), g.videoID || (g.videos = a, g.videoCounter = 1, g.videoLength = a.length, jQuery(g).data("property", a[0]), jQuery(g).YTPlayer()), "function" == typeof c && jQuery(g).one("YTPChanged", function() { c(g) }), jQuery(g).on("YTPEnd", function() { jQuery(g).YTPPlayNext() }), this)
        },
        ...
        getVolume: function() { var a = this.get(0); return a.player.getVolume() },
        ...
        removeFilter: function(a, b) {
            ...
            else { for (var e in d.filters) c.YTPApplyFilter(e, 0); "function" == typeof b && b(e), d.filters = jQuery.extend(!0, {}, jQuery.mbYTPlayer.defaultFilters) }
        ...
        buildControls: function(YTPlayer) {
            ...
            if (YTPlayer.opt.showYTLogo = YTPlayer.opt.showYTLogo || YTPlayer.opt.printUrl, !jQuery("#controlBar_" + YTPlayer.id).length) {
                ...
                var movieUrl = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.ytLogo).addClass("mb_YTPUrl ytpicon").attr("title", "view on YouTube").on("click", function() { window.open(vURL, "viewOnYT") }),
                    onlyVideo = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.onlyYT).addClass("mb_OnlyYT ytpicon").on("click", function() { jQuery(YTPlayer).YTPFullscreen(YTPlayer.opt.realfullscreen) }),
            ...
            return YTPlayer.player.playVideo(), $YTPlayer.YTPMute(), YTPlayer.player.seekTo(startAt, !0), YTPlayer.checkForStartAt = setInterval(function() {
                ...
                if (YTPlayer.player.getDuration() > 0 && YTPlayer.player.getCurrentTime() >= startAt && canPlayVideo) {
                    ...
                    if (YTPready.time = YTPlayer.currentTime, jQuery(YTPlayer).trigger(YTPready), YTPlayer.preventTrigger = !0, YTPlayer.state = 2, jQuery(YTPlayer).YTPPause(), YTPlayer.opt.mute || jQuery(YTPlayer).YTPUnmute(), YTPlayer.preventTrigger = !1, "undefined" != typeof _gaq && eval(YTPlayer.opt.gaTrack) ? _gaq.push(["_trackEvent", "YTPlayer", "Play", YTPlayer.hasData ? YTPlayer.videoData.title : YTPlayer.videoID.toString()]) : "undefined" != typeof ga && eval(YTPlayer.opt.gaTrack) && ga("send", "event", "YTPlayer", "play", YTPlayer.hasData ? YTPlayer.videoData.title : YTPlayer.videoID.toString()), YTPlayer.opt.autoPlay) {
                        ...
                        YTPStart.time = YTPlayer.currentTime, jQuery(YTPlayer).trigger(YTPStart), "mac" == jQuery.mbBrowser.os.name && jQuery.mbBrowser.safari ? setTimeout(function() { $YTPlayer.YTPPlay() }, 10) : $YTPlayer.YTPPlay()
    ...
    e.fn.cycle = function(i) {
        ...
        return 0 !== this.length || e.isReady ? this.each(function() {
            ...
            if (!l.data("cycle.opts")) {
                ...
                s = e.extend({}, e.fn.cycle.defaults, n, i || {}), s.timeoutId = 0, s.paused = s.paused || !1, s.container = l, s._maxZ = s.maxZ, s.API = e.extend({ _container: l }, e.fn.cycle.API), s.API.log = r, s.API.trigger = function(e, t) { return s.container.trigger(e, t), s.API }, l.data("cycle.opts", s), l.data("cycle.API", s.API), s.API.trigger("cycle-bootstrap", [s, s.API]), s.API.addInitialSlides(), s.API.preInitSlideshow(), s.slides.length && s.API.initSlideshow()
            }
        ...
        calcTx: function(t, i) { var n, s = t; return s._tempFx ? n = e.fn.cycle.transitions[s._tempFx] : i && s.manualFx && (n = e.fn.cycle.transitions[s.manualFx]), n || (n = e.fn.cycle.transitions[s.fx]), s._tempFx = null, this.opts()._tempFx = null, n || (n = e.fn.cycle.transitions.fade, s.API.log('Transition "' + s.fx + '" not found.  Using fade.')), n },
        prepareTx: function(e, t) { var i, n, s, o, c, l = this.opts(); return l.slideCount < 2 ? void(l.timeoutId = 0) : (!e || l.busy && !l.manualTrump || (l.API.stopTransition(), l.busy = !1, clearTimeout(l.timeoutId), l.timeoutId = 0), void(l.busy || (0 !== l.timeoutId || e) && (n = l.slides[l.currSlide], s = l.slides[l.nextSlide], o = l.API.getSlideOpts(l.nextSlide), c = l.API.calcTx(o, e), l._tx = c, e && void 0 !== o.manualSpeed && (o.speed = o.manualSpeed), l.nextSlide != l.currSlide && (e || !l.paused && !l.hoverPaused && l.timeout) ? (l.API.trigger("cycle-before", [o, n, s, t]), c.before && c.before(o, n, s, t), i = function() { l.busy = !1, l.container.data("cycle.opts") && (c.after && c.after(o, n, s, t), l.API.trigger("cycle-after", [o, n, s, t]), l.API.queueTransition(o), l.API.updateView(!0)) }, l.busy = !0, c.transition ? c.transition(o, n, s, t, i) : l.API.doTransition(o, n, s, t, i), l.API.calcNextSlide(), l.API.updateView()) : l.API.queueTransition(o)))) },
        doTransition: function(t, i, n, s, o) {
            var c = t,
                l = e(i),
                r = e(n),
                a = function() { r.animate(c.animIn || { opacity: 1 }, c.speed, c.easeIn || c.easing, o) };
            r.css(c.cssBefore || {}), l.animate(c.animOut || {}, c.speed, c.easeOut || c.easing, function() { l.css(c.cssAfter || {}), c.sync || a() }), c.sync && a()
        },
        ...
        advanceSlide: function(e) { var t = this.opts(); return clearTimeout(t.timeoutId), t.timeoutId = 0, t.nextSlide = t.currSlide + e, t.nextSlide < 0 ? t.nextSlide = t.slides.length - 1 : t.nextSlide >= t.slides.length && (t.nextSlide = 0), t.API.prepareTx(!0, e >= 0), !1 },
        buildSlideOpts: function(i) {
            ...
            try { delete c.API, delete c.slideCount, delete c.currSlide, delete c.nextSlide, delete c.slides } catch (r) {}
            return c
        },
        ...
        updateView: function(e, t, i) {
            ...
            if (n._initialized) {
                ...
                !e && t !== !0 && (n.API.trigger("cycle-update-view-before", [n, s, o]), n.updateView < 0) || (n.slideActiveClass && n.slides.removeClass(n.slideActiveClass).eq(n.currSlide).addClass(n.slideActiveClass), e && n.hideNonActive && n.slides.filter(":not(." + n.slideActiveClass + ")").css("visibility", "hidden"), 0 === n.updateView && setTimeout(function() { n.API.trigger("cycle-update-view", [n, s, o, e]) }, s.speed / (n.sync ? 2 : 1)), 0 !== n.updateView && n.API.trigger("cycle-update-view", [n, s, o, e]), e && n.API.trigger("cycle-update-view-after", [n, s, o]))
            }
        },
        ...
        stackSlides: function(t, i, n) {
            ...
            var o, c = s.maxZ - 2,
                l = s.slideCount;
            if (n) { for (o = s.currSlide + 1; l > o; o++) e(s.slides[o]).css("zIndex", c--); for (o = 0; o < s.currSlide; o++) e(s.slides[o]).css("zIndex", c--) } else { for (o = s.currSlide - 1; o >= 0; o--) e(s.slides[o]).css("zIndex", c--); for (o = l - 1; o > s.currSlide; o--) e(s.slides[o]).css("zIndex", c--) }
        ...
        scrollVert: {
            before: function(e, t, i, n) {
                ...
                e.cssBefore = { top: n ? -s : s, left: 0, opacity: 1, visibility: "visible", display: "block" }, e.cssAfter = { zIndex: e - 1, top: 0 }, e.animIn = { top: 0 }, e.animOut = { top: n ? s : -s }
            }
        }
    }, e.fn.cycle.defaults = { allowWrap: !0, autoSelector: ".cycle-slideshow[data-cycle-auto-init!=false]", delay: 0, easing: null, fx: "fade", hideNonActive: !0, loop: 0, manualFx: void 0, manualSpeed: void 0, manualTrump: !0, maxZ: 100, pauseOnHover: !1, reverse: !1, slideActiveClass: "cycle-slide-active", slideClass: "cycle-slide", slideCss: { position: "absolute", top: 0, left: 0 }, slides: "> img", speed: 500, startingSlide: 0, sync: !0, timeout: 4e3, updateView: 0 }, e(document).ready(function() { e(e.fn.cycle.defaults.autoSelector).cycle() })
}(jQuery),
function(e) {
    "use strict";
    ...
    e.extend(e.fn.cycle.defaults, { autoHeight: 0, autoHeightSpeed: 250, autoHeightEasing: null }), e(document).on("cycle-initialized", function(i, o) {
        ...
        var l, r = o.autoHeight,
            a = e.type(r),
            d = null;
        ("string" === a || "number" === a) && (o.container.on("cycle-slide-added cycle-slide-removed", t), o.container.on("cycle-destroyed", s), "container" == r ? o.container.on("cycle-before", n) : "string" === a && /\d+\:\d+/.test(r) && (l = r.match(/(\d+)\:(\d+)/), l = l[1] / l[2], o._autoHeightRatio = l), "number" !== a && (o._autoHeightOnResize = function() { clearTimeout(d), d = setTimeout(c, 50) }, e(window).on("resize orientationchange", o._autoHeightOnResize)), setTimeout(c, 30))
    })
}(jQuery),
function(e) {
    "use strict";
...
function(e) {
    ...
    e.extend(e.fn.cycle.defaults, { loader: !1 }), e(document).on("cycle-bootstrap", function(t, i) {
        function n(t, n) {
            function o(t) { var o; "wait" == i.loader ? (l.push(t), 0 === a && (l.sort(c), s.apply(i.API, [l, n]), i.container.removeClass("cycle-loading"))) : (o = e(i.slides[i.currSlide]), s.apply(i.API, [t, n]), o.show(), i.container.removeClass("cycle-loading")) }
            ...
            a && (t.css("visibility", "hidden").appendTo("body").each(function(t) {
                function c() { 0 === --r && (--a, o(d)) }
                var r = 0,
                    d = e(this),
                    u = d.is("img") ? d : d.find("img");
                return d.data("index", t), u = u.filter(":not(.cycle-loader-ignore)").filter(':not([src=""])'), u.length ? (r = u.length, void u.each(function() { this.complete ? c() : e(this).load(function() { c() }).on("error", function() { 0 === --r && (i.API.log("slide skipped; img not loaded:", this.src), 0 === --a && "wait" == i.loader && s.apply(i.API, [l, n])) }) })) : (--a, void l.push(d))
...
function(e) {
    ...
    function t(t, i, n) {
        ...
        o.each(function() {
            ...
            s.on(t.pagerEvent, function(e) { t.pagerEventBubble || e.preventDefault(), t.API.page(o, e.currentTarget) })
        })
    }
    ...
    e.extend(e.fn.cycle.defaults, { pager: "> .cycle-pager", pagerActiveClass: "cycle-pager-active", pagerEvent: "click.cycle", pagerEventBubble: void 0, pagerTemplate: "<span>•</span>" }), e(document).on("cycle-bootstrap", function(e, i, n) { n.buildPagerLink = t }), e(document).on("cycle-slide-added", function(e, t, n, s) { t.pager && (t.API.buildPagerLink(t, n, s), t.API.page = i) }), e(document).on("cycle-slide-removed", function(t, i, n, s) {
        if (i.pager) {
        ...
        var s;
        i.pager && (s = i.API.getComponent("pager"), s.each(function() { e(this).children().removeClass(i.pagerActiveClass).eq(i.currSlide).addClass(i.pagerActiveClass) }))
...
function(e) {
    ...
    e.extend(e.fn.cycle.defaults, { next: "> .cycle-next", nextEvent: "click.cycle", disabledClass: "disabled", prev: "> .cycle-prev", prevEvent: "click.cycle", swipe: !1 }), e(document).on("cycle-initialized", function(e, t) {
        if (t.API.getComponent("next").on(t.nextEvent, function(e) { e.preventDefault(), t.API.next() }), t.API.getComponent("prev").on(t.prevEvent, function(e) { e.preventDefault(), t.API.prev() }), t.swipe) {
            ...
            t.container.on(i, function(e) { t._tempFx = t.swipeFx, t.API.next() }), t.container.on(n, function() { t._tempFx = t.swipeFx, t.API.prev() })
        }
...
function(e) {
    ...
    e.extend(e.fn.cycle.defaults, { progressive: !1 }), e(document).on("cycle-pre-initialize", function(t, i) {
        if (i.progressive) {
            ...
            else if ("string" == a) { if (s = e(i.progressive), n = e.trim(s.html()), !n) return; if (/^(\[)/.test(n)) try { n = e.parseJSON(n) } catch (d) { return void o.log("error parsing progressive slides", d) } else n = n.split(new RegExp(s.data("cycle-split") || "\n")), n[n.length - 1] || n.pop() }
            r && (o.prepareTx = function(e, t) { var s, o; return e || 0 === n.length ? void r.apply(i.API, [e, t]) : void(t && i.currSlide == i.slideCount - 1 ? (o = n[0], n = n.slice(1), i.container.one("cycle-slide-added", function(e, t) { setTimeout(function() { t.API.advanceSlide(1) }, 50) }), i.API.add(o)) : t || 0 !== i.currSlide ? r.apply(i.API, [e, t]) : (s = n.length - 1, o = n[s], n = n.slice(0, s), i.container.one("cycle-slide-added", function(e, t) { setTimeout(function() { t.currSlide = 1, t.API.advanceSlide(-1) }, 50) }), i.API.add(o, !0))) }), c && (o.next = function() {
                var e = this.opts();
...
! function(i) {
    ...
    i.fn.cycle.transitions.scrollVert = {
        before: function(i, t, e, s) {
            ...
            i.API.stackSlides(i, t, e, s), i.cssBefore = { top: s ? -o : o, left: 0, opacity: 1, display: "block", visibility: "visible" }, i.animIn = { top: 0 }, i.animOut = { top: s ? o : -o }
        }
    }
}(jQuery);
/*!
...
var option_overlay_skin = "black",
    ...
    option_hero_background_mode = "slider",
    option_hero_background_image_path = [{ src: "assets/images/1.jpg" }],
    option_hero_background_slider_path = [{ src: "assets/images/1.jpg" }, { src: "assets/images/2.jpg" }, { src: "assets/images/3.jpg" }],
    ...
    option_hero_background_kenburns_path = [{ src: "assets/images/1.jpg" }, { src: "assets/images/2.jpg" }, { src: "assets/images/3.jpg" }],
...
function customBackground() { $("#canvas").css("background", "#00AB39") }
...
if (jQuery(window).load(function() {
        "use strict";
        setTimeout(function() { $(".options-panel .panel-button").css("margin-right", "-43px") }, 3600)
    }), $(document).ready(function() {
        "use strict";
        $(".options-panel .panel-button").click(function() { $(".options-panel").toggleClass("active") }), $("#hero, #overlay").click(function() { $(".options-panel").removeClass("active") }), $("#overlay-skin p").click(function() { $("#overlay-skin p").removeClass("active"), $(this).addClass("active"), $(this).hasClass("overlay-skin-white") ? $("body").addClass("white") : $("body").removeClass("white") }), $("#bullet-navigation p").click(function() { $("#bullet-navigation p").removeClass("active"), $(this).addClass("active"), $(this).hasClass("bullet-navigation-on") ? $(".grcs_bullet_nav").show() : $(".grcs_bullet_nav").hide() }), $("#overlay-animation p").click(function() { $("#overlay-animation p").removeClass("active"), $(this).addClass("active"), $(this).hasClass("overlay-animation-fade") ? ($("#overlay").addClass("edit"), $("#overlay").addClass("fade-In"), $("#overlay").removeClass("slide-from-bottom"), setTimeout(function() { $("#overlay").removeClass("edit") }, 10)) : ($("#overlay").addClass("edit"), $("#overlay").removeClass("fade-In"), $("#overlay").addClass("slide-from-bottom"), setTimeout(function() { $("#overlay").removeClass("edit") }, 10)) }), $("#overlay-content-animation p").click(function() { $("#overlay-content-animation p").removeClass("active"), $(this).addClass("active"), $(this).hasClass("overlay-content-animation-fade") ? ($("#overlay > .overlay").addClass("edit"), $("#overlay > .overlay").addClass("fade-In"), $("#overlay > .overlay").removeClass("slide-from-bottom"), setTimeout(function() { $("#overlay > .overlay").removeClass("edit") }, 10)) : ($("#overlay > .overlay").addClass("edit"), $("#overlay > .overlay").removeClass("fade-In"), $("#overlay > .overlay").addClass("slide-from-bottom"), setTimeout(function() { $("#overlay > .overlay").removeClass("edit") }, 10)) }), $(".options-panel .gravity-remove-button").click(function() { $("#canvas canvas").length && ($("html, body").animate({ scrollTop: "0" }), $("#canvas canvas").remove(), $(".options-panel .gravity-remove-button,.options-panel .pei").remove()) }), ("waves" === option_hero_background_mode || "sphere" === option_hero_background_mode || "mesh" === option_hero_background_mode || "space" === option_hero_background_mode || "abstract" === option_hero_background_mode || $("#hero").hasClass("half-height")) && $(".options-panel .gravity-remove-button,.options-panel .pei").remove()
...
prevent_class_removal = !0, $(".hero .container-mid").addClass("block-overflow"), jQuery(window).on("load", function() {
    "use strict";
    setTimeout(function() { $("#page-loader").addClass("hide-this"), $("#cycle").cycle("goto", "0"), setTimeout(function() { $(".hero .background-content.page-enter-animated").addClass("show"), setTimeout(function() { $(".hero .front-content.page-enter-animated").addClass("show"), setTimeout(function() { blockProcess = !1, $(".grcs_bullet_nav").addClass("init"), setTimeout(function() { 1 == prevent_class_removal && $(".hero .container-mid").removeClass("block-overflow") }, 1e3) }, 1e3) }, 600), $(".social-icons li a").tooltip({ container: "body", delay: { show: 150, hide: 0 } }) }, 200) }, 600)
});
...
if (isMobile.any() && jQuery("body").addClass("is-mobile"), $(document).ready(function() {
        ...
        ! function(e, o, a, s) {
            ...
            function b() {
                ...
                blockProcess = !0, n.addClass("movement-in-progress"), 0 === f && (prevent_class_removal = !1, $(".hero .container-mid").addClass("block-overflow"), m.children().css("transition", "all 1000ms 500ms"), u.addClass("overlay-active"), u.removeClass("show"), u.find("div.controls").removeClass("show"), $("#cycle").cycle("pause"), setTimeout(function() { n.addClass("open") }, 200)), 0 == c ? f += 1 : (f = i, c = !1), r.removeClass("active"), t = r.eq(f - 1), $(".social-icons li a").tooltip("hide"), setTimeout(function() { t.addClass("active"), g(), setTimeout(function() { l.addClass("active"), setTimeout(function() { blockProcess = !1, n.removeClass("movement-in-progress") }, 800) }, 400) }, 1e3)
            }

            function p() {
                if (0 === f || !0 === blockProcess) return !1;
                blockProcess = !0, n.addClass("movement-in-progress"), 0 == c ? f -= 1 : (f = i, c = !1), r.removeClass("active"), t = r.eq(f - 1), setTimeout(function() { t.addClass("active"), g(), setTimeout(function() { blockProcess = !1, n.removeClass("movement-in-progress") }, 800) }, 800), 0 === f && (l.removeClass("active"), setTimeout(function() { prevent_class_removal = !0, m.children().css("transition", "all 800ms 200ms"), u.removeClass("overlay-active"), u.addClass("show"), "youtube" === option_hero_background_mode && setTimeout(function() { u.find("div.controls").addClass("show") }, 200), setTimeout(function() { 1 == prevent_class_removal && $(".hero .container-mid").removeClass("block-overflow") }, 1300), setTimeout(function() { $("#cycle").cycle("resume") }, 1400), n.removeClass("open") }, 800))
            }

            function g() { "on" !== option_overlay_bullet_navigation || $(".hero").hasClass("error-404") || ($(".grcs_bullet_nav .nav_dots").removeClass("active"), $(".grcs_bullet_nav .nav_dots").eq(f).addClass("active")) }
            ...
            }(), d.click(function() { b() }), l.click(function() { p() }), $("html").on("DOMMouseScroll mousewheel", function(e) {
        ...
        }("#overlay", "section.overlay", "#hero .front-content", "#hero .front-content .container-mid"), $(".subscribe-form").submit(function() { var e = $(".subscribe-form").serialize(); return $.ajax({ type: "POST", url: "assets/php/subscribe.php", data: e, dataType: "json", success: function(e) { $(".subscribe-form").removeClass("error").removeClass("error-final"), 0 === e.valid ? ($(".subscribe-form").addClass("error"), $(".subscribe-form input").attr("placeholder", e.message), $(".subscribe-form input").val(""), setTimeout(function() { $(".subscribe-form").addClass("error-final") }, 1500)) : ($(".subscribe-form input,.subscribe-form button").val("").prop("disabled", !0), $(".subscribe-form input").attr("placeholder", e.message), $(".subscribe-form").addClass("success")) } }), !1 }), $("#contact-form").submit(function(e) {
            e.preventDefault();
            var o = $(this).serialize();
            $.ajax({ type: "POST", url: "assets/php/contact.php", data: o, dataType: "json", success: function(e) { $("#contact-form.error input, #contact-form.error textarea").removeClass("active"), setTimeout(function() { "" !== e.nameMessage && ($("#contact-form-name").addClass("active").attr("placeholder", e.nameMessage), $("#contact-form").addClass("error")), "" !== e.emailMessage && ($("#contact-form-email").addClass("active").val("").attr("placeholder", e.emailMessage), $("#contact-form").addClass("error")), "" !== e.messageMessage && ($("#contact-form-message").addClass("active").attr("placeholder", e.messageMessage), $("#contact-form").addClass("error")) }, 50), "" === e.nameMessage && "" === e.emailMessage && "" === e.messageMessage && ($("#contact-form").removeClass("error").addClass("success"), $("#contact-form textarea, #contact-form input").attr("placeholder", ""), $("#contact-form textarea").attr("placeholder", e.succesMessage), $("#contact-form input, #contact-form button, #contact-form textarea").val("").prop("disabled", !0)) } })
        })
...
$(document).ready(function() {
    ...
    function t() { $(".bg-image").vegas({ slides: option_hero_background_image_path, delay: 6e3, transitionDuration: 800, timer: !1 }) }
    ...
    function e() {
        ...
        function l(t) { a = t.clientX - r, s = t.clientY - h }

        function u(t) { t.touches.length > 1 && (t.preventDefault(), a = t.touches[0].pageX - r, s = t.touches[0].pageY - h) }

        function d(t) { 1 === t.touches.length && (t.preventDefault(), a = t.touches[0].pageX - r, s = t.touches[0].pageY - h) }! function() {
            var a, s;
            ...
            for (var r = 2 * Math.PI, h = new THREE.SpriteCanvasMaterial({ color: option_hero_background_sphere_dot_color, program: function(t) { t.beginPath(), t.arc(0, 0, .5, 0, r, !0), t.fill() } }), g = 0; g < 1e3; g++)(s = new THREE.Sprite(h)).position.x = 2 * Math.random() - 1, s.position.y = 2 * Math.random() - 1, s.position.z = 2 * Math.random() - 1, s.position.normalize(), s.position.multiplyScalar(10 * Math.random() + 450), s.scale.multiplyScalar(2), e.add(s);
            for (var g = 0; g < 300; g++) {
                ...
                var f = new THREE.Line(p, new THREE.LineBasicMaterial({ color: option_hero_background_sphere_line_color, opacity: Math.random() }));
                e.add(f)
            }
        ...
        var g = !0;
        $(document).scroll(function() { g = !($(this).scrollTop() > $(window).height()) })
    }
    ...
    function o() {
        ...
        function f(t) { d = t.clientX - p, g = t.clientY - _ }

        function v(t) { t.touches.length > 1 && (t.preventDefault(), d = t.touches[0].pageX - p, g = t.touches[0].pageY - _) }

        function b(t) { 1 === t.touches.length && (t.preventDefault(), d = t.touches[0].pageX - p, g = t.touches[0].pageY - _) }! function() {
            ...
            for (var u = 2 * Math.PI, d = new THREE.SpriteCanvasMaterial({ color: option_hero_background_waves_dot_color, program: function(t) { t.beginPath(), t.arc(0, 0, .5, 0, u, !0), t.fill() } }), g = 0, p = 0; p < r; p++)
        ...
        var y = !0;
        $(document).scroll(function() { y = !($(this).scrollTop() > $(window).height()) })
    }

    function i() {
        $(".hero .bg-pattern").remove(), $(".hero .bg-overlay").remove();
        var t, e, o, i, n, a, s, r = setInterval(function() { $(".hero .level-1 #canvas").offset().top <= 0 && ($(".hero .level-1 #canvas").css({ WebkitTransition: "all .4s", transition: "all .4s" }), $(".hero .level-1 #canvas").css("background", option_hero_background_abstract_bg_color), clearInterval(r)) }, 50),
            h = { width: option_hero_background_width / 100, height: 1.8, depth: 60, segments: 9, slices: 8, xRange: option_hero_background_width_expansion, yRange: .1, zRange: 1, ambient: "#666666", diffuse: "#fff", speed: option_hero_background_move_speed / 1e4 },
            c = { count: 2, xyScalar: 1, zOffset: 100, ambient: "#fff", diffuse: "#b3b3b3", speed: 2e-4, gravity: 500, dampening: .95, minLimit: 10, maxLimit: null, minDistance: 20, maxDistance: 400, autopilot: !0, draw: !1, bounds: FSS.Vector3.create(), step: FSS.Vector3.create(Math.randomInRange(.2, 1), Math.randomInRange(.2, 1), Math.randomInRange(.2, 1)) },
            l = { renderer: "canvas" },
            u = Date.now(),
        ...
        function m() { var t, s; for (o.remove(i), e.clear(), n = new FSS.Plane(h.width * e.width, h.height * e.height, h.segments, h.slices), a = new FSS.Material(h.ambient, h.diffuse), i = new FSS.Mesh(n, a), o.add(i), t = n.vertices.length - 1; t >= 0; t--)(s = n.vertices[t]).anchor = FSS.Vector3.clone(s.position), s.step = FSS.Vector3.create(Math.randomInRange(.2, 1), Math.randomInRange(.2, 1), Math.randomInRange(.2, 1)), s.time = Math.randomInRange(0, Math.PIM2) }

        function f(t, o) { e.setSize(t, o), FSS.Vector3.set(d, e.halfWidth, e.halfHeight), m() }
        ...
        function y(t) { f(p.offsetWidth, p.offsetHeight), b() }
        if (s = new FSS.CanvasRenderer, l.renderer, e && _.removeChild(e.element), (e = s).setSize(p.offsetWidth, p.offsetHeight), _.appendChild(e.element), o = new FSS.Scene, m(), function() { var t, i; for (t = o.lights.length - 1; t >= 0; t--) i = o.lights[t], o.remove(i); for (e.clear(), t = 0; t < c.count; t++)(i = new FSS.Light(c.ambient, c.diffuse)).ambientHex = i.ambient.format(), i.diffuseHex = i.diffuse.format(), o.add(i), i.mass = Math.randomInRange(.5, 1), i.velocity = FSS.Vector3.create(), i.acceleration = FSS.Vector3.create(), i.force = FSS.Vector3.create(), i.ring = document.createElementNS(FSS.SVGNS, "circle"), i.ring.setAttributeNS(null, "stroke", i.ambientHex), i.ring.setAttributeNS(null, "stroke-width", "0.5"), i.ring.setAttributeNS(null, "fill", "none"), i.ring.setAttributeNS(null, "r", "10"), i.core = document.createElementNS(FSS.SVGNS, "circle"), i.core.setAttributeNS(null, "fill", i.diffuseHex), i.core.setAttributeNS(null, "r", "4") }(), window.addEventListener("resize", y), f(p.offsetWidth, p.offsetHeight), v(), canvas.getContext) {
            var x = canvas.getContext("2d"),
                w = !0;
            canvas.height = screen.height - 60, canvas.width = screen.width + 20, initialize(), initialize();
            setInterval(function() { for (var t = 1; t <= 1e3; t++) x.beginPath(), w ? (x.moveTo(0, randomize(canvas.height + 10)), w = !1) : (x.moveTo(randomize(canvas.width + 10), 0), w = !0), x.lineTo(randomize(canvas.width + 50), randomize(canvas.height + 50)), x.lineTo(randomize(canvas.width + 50), randomize(canvas.height + 50)), x.fillStyle = getRndColor(), x.fill() }, 5e3)
        }
    }
        ...
        "on" === option_hero_gravity_effect && function() {
            function t(t, e) {
                var o = $(".hero .level-1").width(),
                    ...
                    a = $(t),
                    s = t.getContext("2d"),
                    r = { star: { color: "rgba(255, 255, 255, .65)", width: 1 }, line: { color: "rgba(255, 255, 255, .65)", width: .2 }, position: { x: 0, y: 0 }, width: o, height: i, velocity: .2, length: n, distance: 120, radius: 200, stars: [] },
                    h = $.extend(!0, {}, r, e);

                function c() { this.x = Math.random() * t.width, this.y = Math.random() * t.height, this.vx = h.velocity - .5 * Math.random(), this.vy = h.velocity - .5 * Math.random(), this.radius = Math.random() * h.star.width }
                c.prototype = {
                    create: function() { s.beginPath(), s.arc(this.x, this.y, this.radius, 0, 2 * Math.PI, !1), s.fill() },
                    animate: function() {
                        var e;
                ...
                }, this.setCanvas = function() { t.width = h.width, t.height = h.height, s.fillStyle = h.star.color, s.strokeStyle = h.line.color, s.lineWidth = h.line.width, e && e.hasOwnProperty("position") || (h.position = { x: .5 * t.width, y: .5 * t.height }) }, this.loop = function(t) { t(), window.requestAnimationFrame(function() { this.loop(t) }.bind(this)) }, this.bind = function() { $(window).on("mousemove", function(t) { h.position.x = t.pageX - a.offset().left, h.position.y = t.pageY - a.offset().top }) }, this.init = function() { this.setCanvas(), this.loop(this.createStars), this.bind() }
            }
            ...
            var e = (o = {}, function(t, e, i) { i || (i = "Don't call this twice without a uniqueId"), o[i] && clearTimeout(o[i]), o[i] = setTimeout(t, e) });
            var o;
            $(window).resize(function() { e(function() { $("#canvas canvas").constellation({}) }, 500, "some unique string") })
        }()
    }
    ...
    switch (option_hero_background_mode) {
        case "image":
            ...
            break;
        case "slider":
            $(".bg-image").vegas({ slides: option_hero_background_slider_path, transition: option_hero_background_slider_transition, delay: option_hero_background_slider_delay, transitionDuration: option_hero_background_slider_transitionDuration, firstTransitionDuration: 1, timer: !1, walk: function(t, e) { $("#cycle").cycle("next") } }), n();
            break;
        case "kenburns":
            $(".bg-image").vegas({ slides: option_hero_background_kenburns_path, transition: option_hero_background_kenburns_transition, delay: option_hero_background_kenburns_delay, transitionDuration: option_hero_background_kenburns_transitionDuration, firstTransitionDuration: 1, timer: !1, animation: "kenburns", walk: function(t, e) { $("#cycle").cycle("next") } }), n();
            break;
        case "youtube":
            jQuery.browser.mobile ? t() : function() {
                "on" === option_hero_background_youtube_controls && $(".hero .front-content").append('<div class="controls"><i class="volume-button fa fa-volume-up"></i><i class="pause-button ti-control-pause"></i></div>'), "on" === option_hero_background_youtube_mute && (option_hero_background_youtube_mute = !0, $(".volume-button").removeClass("fa-volume-up").addClass("fa-volume-off")), "off" === option_hero_background_youtube_mute && (option_hero_background_youtube_mute = !1), "off" === option_hero_background_youtube_loop ? option_hero_background_youtube_loop = !1 : option_hero_background_youtube_loop = !0, $(".hero .bg-video").append('<div id="bg-youtube" class="player showOn-video-bg"></div>'), $(".hero #bg-youtube").attr("data-property", '{videoURL:option_hero_background_youtube_url,containment:".bg-video",autoPlay:true,mute:option_hero_background_youtube_mute,startAt: option_hero_background_youtube_startPoint,stopAt: option_hero_background_youtube_endPoint,loop: option_hero_background_youtube_loop,opacity:1,stopMovieOnBlur:false,showControls:false}'), $(".player").mb_YTPlayer(), $(".hero .controls").addClass("show"), $(".volume-button").click(function() { $("#bg-youtube").hasClass("isMuted") ? ($("#bg-youtube").YTPUnmute(), $(".volume-button").removeClass("fa-volume-off").addClass("fa-volume-up")) : ($("#bg-youtube").YTPMute(), $(".volume-button").removeClass("fa-volume-up").addClass("fa-volume-off")) });
                var t = !0;
                $("#bg-youtube").on("YTPPause", function() { t = !1 }), $("#bg-youtube").on("YTPPlay", function() { t = !0 }), $(".pause-button").click(function() { 1 == t ? ($("#bg-youtube").YTPPause(), $(".pause-button").removeClass("ti-control-pause").addClass("ti-control-play")) : ($("#bg-youtube").YTPPlay(), $(".pause-button").removeClass("ti-control-play").addClass("ti-control-pause")) })
            }(), n();
            break;
        case "color":
        ...
        case "gradient":
            r = option_hero_background_gradient_colorArray, h = 0, c = $(".bg-color"), l = [0, 1, 2, 3], u = option_hero_background_gradient_stransitionSpeed / 1e4, setInterval(function() {
                ...
                c.css({ background: "-webkit-gradient(linear, left top, right top, from(" + a + "), to(" + s + "))" }).css({ background: "-moz-linear-gradient(left, " + a + " 0%, " + s + " 100%)" }), (h += u) >= 1 && (h %= 1, l[0] = l[1], l[2] = l[3], l[1] = (l[1] + Math.floor(1 + Math.random() * (r.length - 1))) % r.length, l[3] = (l[3] + Math.floor(1 + Math.random() * (r.length - 1))) % r.length)
            }, 1), $(".hero .bg-color").css("opacity", "1"), $(".hero .bg-pattern").remove(), $(".hero .bg-overlay").remove(), n();
            break;
        case "sphere":
            a("assets/js/plugins/three.min.js", function() { e() });
            break;
        case "waves":
            a("assets/js/plugins/three.min.js", function() { o() });
            break;
        case "mesh":
            ! function() {
                var t, e, o, i, n, a, s, r, h, c, l, u, d, g, p;

                function _(t) { this.x = t.x, this.y = t.y, this.xBase = this.x, this.yBase = this.y, this.offset = m(0, 1e3), this.duration = m(20, 60), this.range = m(5, 5), this.dir = m(0, 1) > .5 ? 1 : -1, this.rad = m(2, 4) }

                function m(t, e) { return Math.random() * (e - t) + t }

                function f() {
                    o = $(".hero .level-1").width(), i = $(".hero .level-1").height(), t.width = o, t.height = i, c.x = o / 2, c.y = i / 2, l = !1, u = 0, d = 0, g.length = 0, p = 0,
                        function() { for (var t = -n / 2; t < o + n; t += n) { u++; for (var e = -n / 2; e < i + n; e += n) t == -n / 2 && d++, g.push(new _({ x: ~~(t + m(-a, a)), y: ~~(e + m(-a, a)) })) } }(), e.strokeStyle = option_hero_background_mesh_color, e.lineWidth = 2
                }

                function v() {
                    requestAnimationFrame(v), l || (c.x = o / 2 + 90 * Math.cos(p / 40), c.y = i / 2 + 90 * Math.sin(p / 40)), g.forEach(function(t) { t.step() }), p++,
                        function() {
                            ...
                            e.stroke(), e.fillStyle = "#000", g.forEach(function(t) { e.save(), e.beginPath(), e.translate(t.x, t.y), e.rotate(Math.PI / 4), e.rect(0, 0, 0, 0), e.fill(), e.stroke(), e.restore() });
                ...
                }, window.addEventListener("resize", f), window.addEventListener("mousemove", function(t) { l = !0, c.x = t.pageX, c.y = t.pageY }), t = document.createElement("canvas"), e = t.getContext("2d"), c = { x: 0, y: 0 }, g = [], a = .25 * (n = 180), document.getElementById("canvas").appendChild(t), f(), v(), $(".hero .background-content #canvas canvas").css("background-color", option_hero_background_mesh_background_color)
            }();
            break;
        case "space":
            ! function(t, e, o, i) {
                var n, a, s, r = function(e, o) { this.el = e, this.$el = t(e), this.options = o, s = this },
                    h = !1,
                    c = !1;
                ! function() {
                    ...
                    e.requestAnimationFrame || (e.requestAnimationFrame = function(o, i) {
                        var n = (new Date).getTime(),
                            a = Math.max(0, 16 - (n - t)),
                            s = e.setTimeout(function() { o(n + a) }, a);
                        return t = n + a, s
                    }), e.cancelAnimationFrame || (e.cancelAnimationFrame = function(t) { clearTimeout(t) })
                }(), r.prototype = {
                    defaults: { starColor: option_hero_background_star_star_color, bgColor: option_hero_background_star_background_color, mouseMove: !0, mouseColor: "rgba(0,0,0,0.2)", mouseSpeed: 15, speed: option_hero_background_space_star_speed, quantity: option_hero_background_space_star_amount, ratio: option_hero_background_space_star_amount / 2, divclass: "starfield" },
                    resizer: function() {
                        var t = this.star,
                    ...
                    loop: function() { this.anim(), a = e.requestAnimationFrame(function() { s.loop() }) },
                    move: function() {
                        ...
                        }, !1) : e.addEventListener("mousemove", function(e) { s.cursor_x = e.pageX || e.clientX + t.scrollLeft - t.clientLeft, s.cursor_y = e.pageY || e.clientY + t.scrollTop - t.clientTop }, !1)
                    },
                    stop: function() { e.cancelAnimationFrame(a), n = !1 },
                    start: function() { return h || (h = !0, this.init()), n || (n = !0, this.loop()), e.addEventListener("resize", function() { s.resizer() }, !1), e.addEventListener("orientationchange", function() { s.resizer() }, !1), this.settings.mouseMove && this.move(), this }
                }, r.defaults = r.prototype.defaults, t.fn.starfield = function(t) { return this.each(function() { new r(this, t).start() }) }, e.Starfield = r
            }(jQuery, window, document), $("#canvas").starfield();
            break;
        case "abstract":
            a("assets/js/plugins/fss.min.js", function() { i() });
            break;
        case "glitch":
            s = "background-image: url('" + option_hero_background_glitch_image + "')", $(".hero .level-2 .bg-image").append('<div class="glitch-img" style="' + s + '"></div>'), $(".glitch-img").mgGlitch({ destroy: !1, glitch: !0, scale: !0, blend: !0, blendModeType: "hue", glitch1TimeMin: 600, glitch1TimeMax: 900, glitch2TimeMin: 10, glitch2TimeMax: 115, zIndexStart: 8 }), n();
            break;
        case "custom":
            customBackground(), n();
            break;
    ...
    if ("on" == option_hero_parallax_hover_effect) {
        var d = $(".hero").parallax({ scalarX: 24, scalarY: 15, frictionX: .1, frictionY: .1 });
        $(".hero").hover(function() { d.parallax("enable") }, function() { d.parallax("disable") })
    }
    var g = 800,
        p = 6e3;
    "slider" === option_hero_background_mode && (g = option_hero_background_slider_transitionDuration, p = option_hero_background_slider_delay), "kenburns" === option_hero_background_mode && (g = option_hero_background_kenburns_transitionDuration, p = option_hero_background_kenburns_delay), $("#cycle").cycle({ fx: "scrollVert", timeout: p, delay: 0, autoHeight: "container", speed: g, slides: ".slide", log: !1 })
});